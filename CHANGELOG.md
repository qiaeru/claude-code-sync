...
- The HTTP API answers a mistyped field with a 400 error instead of a server error or a silently empty selection, and rejects an invalid `keep` before writing the archive rather than after.
